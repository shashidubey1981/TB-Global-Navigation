...
import TMWFooterLinks from './TMWFooterLinks';
import TMWNewsletter from './TMWNewsletter';
import TMWSocialMedia from './TMWSocialMedia';
import TMWCopyright from './TMWCopyright';
...
export default function TMWFooter({ data }: FooterProps) {
  return (
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        {data?.links?.columns && data.links.columns.length > 0 && (
          <TMWFooterLinks columns={data.links.columns} />
        )}
